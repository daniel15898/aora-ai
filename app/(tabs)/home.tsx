  ...
  return (
    <SafeAreaView className="bg-primary h-full ">
      <FlatList
        ...
        ListHeaderComponent={() => <PageHeader latestPosts={latestPosts} userName={user?.username} />}
        ListEmptyComponent={() => (
          <EmptyState
...
const PageHeader = ({latestPosts,userName}:{latestPosts:Models.Document[],userName:string}) => {
  return (
